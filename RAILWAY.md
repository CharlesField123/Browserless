...
4. Deploy. Watch the build logs — first build takes a few minutes
   (installing Chromium). Once it's up, `https://<app>.up.railway.app/pressure`
   should return 200 (that's the health check Railway itself polls) and
   `https://<app>.up.railway.app/docs` should load the API docs.
